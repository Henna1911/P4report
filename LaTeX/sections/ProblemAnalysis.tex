...
Digitally, the way to simulate reverberation is to use a multitude of delays and feedback. This then creates a series of echoes that then slowly decay. 
...
\subsection{TC-Helicon's Perform V}
...
\captionof{figure}{TC-Helicon's Perform V\citep{TC}}\label{tchelicon}
\end{minipage}\\
...
The registration stage is when the system registers that the user wants to perform a gestural input, e.g. when you place your finger(s) on a touch display. 
