...
The p-value ended up being 0.7265 which is not lower than the 0.05 significance level and therefore the result cannot be concluded upon. \\
...
The following figure \ref{Setup} shows the setup of the evaluation. One person wearing the system, a facilitator, and one person that makes sure the system works and has the microphone in his left hand (technician).\\
